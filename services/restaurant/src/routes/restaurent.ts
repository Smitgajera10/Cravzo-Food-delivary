...
import { addRestaurant, fetchMyRestaurant, fetchSigleRestaurant, getNearbyRestaurant, updateRestaurant, updateStatusRestaurant } from '../controllers/restaurant.js';
...
router.get("/:id" , isAuth  , fetchSigleRestaurant)
